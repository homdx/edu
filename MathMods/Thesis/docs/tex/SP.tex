...
\begin{figure}
	...
	\caption{Lower estimate: Illustration of Lemma \ref{lmm:sp-lower-estimate} with $ j = 3, x_{34} = \bar{x}, P_{34} = \bar{P} $}
	\label{fig:lower-estimate}
\end{figure}


The lemmas \ref{lmm:sp-upper-estimate} and \ref{lmm:sp-lower-estimate}, will be used later to reduce the memory requirement of the algorithm by removing points or edges to simplify the function.
...
Table \ref{tab:sp-notation} highlights the discussion above.
