...
def run(ns: list, d: int=6) -> None:
	...
	for n in ns:
		ub = sp_asian_call(r=r, s0=s0, sigma=sigma, q=q, k=k, t=t, am=True, n=n)[0][0][0][1]
		lb = sp_asian_call(r=r, s0=s0, sigma=sigma, q=q, k=k, t=t, am=True, n=n)[0][0][0][1]
		if n < 25:
			ac = sp_asian_call(r=r, s0=s0, sigma=sigma, q=q, k=k, t=t, am=True, n=n)[0][0][0][1]
