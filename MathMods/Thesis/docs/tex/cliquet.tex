...
\begin{proof}
	...
	\begin{equation*}
		\lim_{n \to \infty} \E^* \left( e^{-rT} \psi \left( \bar{S}_j^n, j \in [n] \right) \right)  =  \E^* \left( e^{-rT} \psi \left( S_t, t \in [0, T] \right) \right)
	\end{equation*}
...
\paragraph{tr\_sp\_cliquet.py}
This file contains the function \emph{sp\_cliquet}, which returns the price of the cliquet option at time 0.

\inputminted[tabsize=4]{python}{../code/tr_sp_cliquet.py}
\label{lst:clq}
...
\begin{table}[h]
	...
	\begin{tabular}{rrccccc}
		...
		\midrule
		\multirow{7}{2em}{$ 0.2 $}
		&    10  &  0.165661911  &  0.165661911  &  \multirow{7}{5em}{0.174106 (0.17398 -- 0.17423)}  &    &    \\
		&    20  &  0.172300056  &  0.172300056  &    &    &    \\
		&    50  &  0.172501269  &  0.172501269  &    &    &    \\
		&   100  &  0.172501269  &  0.173927464  &    &    &    \\
		&   200  &  0.173716366  &  0.173716366  &    &    &    \\
		&   500  &  0.173922597  &  0.173922671  &    &    &    \\
		&  1000  &  0.174051949  &  0.174051983  &    &    &    \\
		\midrule
		\multirow{7}{2em}{$ 0.02 $}
		&    10  &  0.151234115  &  0.151234416  &  \multirow{7}{5em}{0.150525 (0.150472 -- 0.150578)}  &    &    \\
		&    20  &  0.149734212  &  0.149734992  &    &    &    \\
		&    50  &  0.150228984  &  0.150230185  &    &    &    \\
		&   100  &  0.150386306  &  0.150387954  &    &    &    \\
		&   200  &  0.150465004  &  0.150466828  &    &    &    \\
		&   500  &  0.150508871  &  0.150510526  &    &    &    \\
		&  1000  &  0.150522368  &  0.150524027  &    &    &    \\
		\midrule
		\multirow{7}{2em}{Var}
