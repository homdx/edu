...
print(getTree(s0 = Decimal('100.0'), sigma = Decimal('0.2'), n = 7, t = Decimal('1')))
eac = EuropeanAsianCallSP(s0 = Decimal('100.0'), k = Decimal('90.0'), sigma = Decimal('0.2'), n = 7, t = Decimal('1.0'))
